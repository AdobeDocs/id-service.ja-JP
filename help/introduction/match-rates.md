...
ページ本文の読み込み中に、ID サービスは&#x200B;*`Destination Publishing iFrame`*&#x200B;というiFrameを読み込みます。 [!UICONTROL Destination Publishing iFrame] は、親ページとは別のドメインに読み込まれます。 この設計によって iFrame は以下の動作をするので、ページパフォーマンスを確保し、セキュリティを強化できます。
