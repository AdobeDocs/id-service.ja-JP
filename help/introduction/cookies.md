...
# CookieとエクスペリエンスプラットフォームIDサービス{#cookies-and-the-experience-cloud-id-service}
...
詳しくは、エクスペリエンスプラットフォームIDサービスのリクエストおよびIDの設定を参照 [してください。](../introduction/id-request.md#concept-2caacebb1d244402816760e9b8bcef6a)
