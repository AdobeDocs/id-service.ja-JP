...
これらの使用例のいずれかがお客様の状況に当てはまる場合は、[カスタマーケア](https://helpx.adobe.com/jp/marketing-cloud/contact-support.html)までお問い合わせいただき、一時的な[猶予期間](https://experienceleague.adobe.com/ja/docs/analytics/implementation/id/migration)を設定するよう依頼してください。猶予期間は最大 180 日間実行できます。 必要に応じて、猶予期間を更新できます。
