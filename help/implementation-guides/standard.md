...
Customers must provide a CNAME or use [!DNL *.sc.omtrdc] for [regional data collection](https://marketing.adobe.com/resources/help/en_US/whitepapers/rdc/) (RDC). [!DNL Adobe] のコンサルタントから、特定の RDC 設定を取得します。
...
設定は、ID サービスを Dynamic Tag Management（DTM）のツールとして追加して保存した後で利用できます。また、DTM Web プロパティの「[!DNL Installed Tools]」セクションのギアアイコンをクリックすることで、これらの設定にアクセスできます。
...
以下の表に、[!DNL General] 設定のリストと定義を示します。
