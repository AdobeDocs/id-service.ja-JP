 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>これらの条件を前提として、以下を含む ID サービスを呼び出します。 </p> 
    ...
    </ul> <p>また、<a href="../implementation-guides/direct-integration.md#concept-4cd3206a84bb4687af0b312ae09648b9" format="dita" scope="local"> direct integration guide に記載されているその他のパラメーター（例：</a> d_blob<span class="codeph"> または </span> dcs_region<span class="codeph">）がある場合は </span> それらも渡すことができます。 </p> </td> 
  </tr> 
  <tr> 
