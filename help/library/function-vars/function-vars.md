---
description: これらのプロパティをVisitor.getInstance静的メソッドに渡すことにより、訪問者ID サービスを設定します。
keywords: IMS組織ID；訪問者ID サービス
title: 設定
...
これらのプロパティをVisitor.getInstance静的メソッドに渡すことにより、訪問者ID サービスを設定します。
