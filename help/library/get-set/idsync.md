---
description: 訪問者ID サービスのidSyncByURL機能とidSyncByDataSource機能を使用すると、宛先公開iFrameでID同期を手動で実装できます。 これらは、VisitorAPI.js バージョン 1.10 以降で利用できます。
...
訪問者ID サービスのidSyncByURL機能とidSyncByDataSource機能を使用すると、宛先公開iFrameでID同期を手動で実装できます。 これらは、`VisitorAPI.js` バージョン 1.10以降で使用できます。
