...
<table id="table_1F7E1CF091604D22B1D9F3F1AE4DB2D7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>この公開メソッドは、<span class="wintitle">Supplemental Data ID</span>（SDID）をクエリ文字列パラメーターとしてリダイレクト URL に追加します。<a href="../library/get-set/appendsupplementaldataidto.md#reference-65d09de6fde0418f8c62fa79304a755d" format="dita" scope="local"> appendSupplementalDataIDToを参照</a>してください。（MCID-285） </p> </td> 
  </tr> 
 </tbody> 
</table>
